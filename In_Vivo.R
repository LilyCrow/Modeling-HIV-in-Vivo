...
#Parameters and initial values also came from https://pdfs.semanticscholar.org/022f/3909c2f6a319345ef2d62f3526cdd5dac0ca.pdf.
#The comments in this file will walk you through the description
#and solving of the below equations. 
#Then it will show you how to manipulate the output so that 
#ggplot can create a plot saved as either a png or a pdf (or a pdf). 

#RTI.R builds upon this file.


#You may need to install the following packages.
#Put install.packages("ggplot2") into the R interpretor(and same for deSolve and tidyr as needed)
library(deSolve)
library(ggplot2)
library(tidyr)
